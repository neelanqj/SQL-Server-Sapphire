...
{	
	...
	private static $user = 'juggerjo_sql';
	private static $pass = 'ForMykids!8';
	
	private static $config = array(
		'write' =>
			array('mysql:dbname=juggerjo_sqlserversapphire;host=localhost'),
		'read' =>
			array('mysql:dbname=juggerjo_sqlserversapphire;host=localhost',
				  'mysql:dbname=juggerjo_sqlserversapphire;host=localhost',
				  'mysql:dbname=juggerjo_sqlserversapphire;host=localhost'),
		'batch' =>
			array('mysql:dbname=juggerjo_sqlserversapphire;host=localhost'),
		'comments' =>
